...
# Cenário 3 - Crie um sistema de lanchonete que exibe na tela pelo menos 5 opções de lanche contendo Código, Nome e Preço. Peça para que o usuário digite o código do lanche deseja e a quantidade. Exiba na tela o valor total da compra.
